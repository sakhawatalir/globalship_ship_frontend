...
interface BlogLatestPostsVariantOneProps extends CommonComponentProps {
  posts: BlogPost[]
}

const BlogLatestPostsVariantOne = ({ posts, className, ...props }: BlogLatestPostsVariantOneProps) => (
